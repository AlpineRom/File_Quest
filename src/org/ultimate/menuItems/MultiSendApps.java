 ...
 *
 */
public class MultiSendApps extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list2 = i.getParcelableArrayListExtra("list");
			...
			public void onClick(View arg0) {
				...
				if(seleted){
					...
					if(list3!=null)
						...
						Toast.makeText(getBaseContext(), "An error encountered while sending files,try later", Toast.LENGTH_SHORT).show();
					finish();

...
@SuppressLint("NewApi")
public class CopyPopupDialog extends Activity{
	...
	private Handler mHandler = new Handler(){
		public void handleMessage(Message msg){
			switch(msg.what){
				...
				case 2:
					/**
					 * If File Exists pause the Thread or handler and then ask for overwriting the file
					 */
					break;
				case 3:
					setResult(70);
